        ...
        <div class="intro-panel">
            ...
            <div class="row" style="padding-top:30px;padding-left:50px">
                <div class="col-xs-6 col-sm-5">
                    ...
                    <input class="form-control pull-left" maxlength="8" required="" type="text" style="width:200px;" >
                </div>
                <div class="col-xs-6 col-sm-6">
                    <button  type="button" class="btn btn-default pull-right" style="margin-left:20px">重置</button>
                    <button type="button" class="btn btn-info pull-right">保存</button>
