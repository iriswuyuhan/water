...
<div class="content">
    <header>
        ...
        <div class="header_main">
            <ul id="nav">
                <li ><a id="sad" class="type1"><i class="fa fa-2x fa-sitemap"></i><h4>审核申请</h4></a></li>
                <li class="active" ><a class="type1"><i class="fa fa-2x fa-download set_middle"></i><h4>下载采样信息</h4></a></li>
